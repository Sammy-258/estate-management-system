...
<!-- Mirrored from demo.zytheme.com/lalan/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Nov 2023 22:08:27 GMT -->
<head>
    <!-- Document Meta
    ============================================= -->
    <meta charset="utf-8">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="slider--content">
                            <div class="text-center">
                                <h1>Find Your Favorite Landed Property</h1>
                            </div>
                            <form class="mb-0">
            ...
            <div class="carousel slider-navs" data-slide="1" data-slide-rs="1" data-autoplay="true" data-nav="true" data-dots="false" data-space="0" data-loop="true" data-speed="800">
                ...
                <div class="slide--item bg-overlay bg-overlay-dark3">
                    <div class="bg-section">
                        <img src="{{ asset('images/slider/slide-bg/3.jpg')}}" alt="background">
                    </div>
                </div>
                <!-- .slide-item end -->
                <!-- Slide #2 -->
                <div class="slide--item bg-overlay bg-overlay-dark3">
                    <div class="bg-section">
                        <img src="{{ asset('images/slider/slide-bg/1.jpg')}}" alt="background">
                    </div>
                </div>
                <!-- .slide-item end -->
                <!-- Slide #3 -->
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="carousel carousel-dots" data-slide="3" data-slide-rs="2" data-autoplay="true" data-nav="false" data-dots="true" data-space="25" data-loop="true" data-speed="800">
                            ...
                            <div class="property-item">
                                <div class="property--img">
                                    <a href="#">
                                        <img src="{{ asset('images/properties/11.jpg')}}" alt="property image" class="img-responsive">
                                        <span class="property--status">For Sale</span>
							        </a>
                                </div>
                                <div class="property--content">
                            ...
                            <div class="property-item">
                                <div class="property--img">
                                    <a href="#">
                            <img src="{{ asset('images/properties/4.jpg')}}" alt="property image" class="img-responsive">
                            <span class="property--status">For Sale</span>
							</a>
                                </div>
                                <div class="property--content">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4">
                        <div class="feature-panel">
                            ...
                            <div class="feature--content">
                                <h3>Search For Landed property</h3>
...
<!-- Mirrored from demo.zytheme.com/lalan/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Nov 2023 22:08:54 GMT -->
</html>
